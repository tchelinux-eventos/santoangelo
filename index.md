[![Tchelinux 2019 Santo Ângelo](images/banner.jpg)](#)
...
| **09:30** <td colspan=4><center>[**Porque e Como Participar de Projetos Open Source**](#Porque_e_Como_Participar_de_Projetos_Open_Source) <br> Auditório TecnoURI <br> <span class="label label-success">Principiante</span> <br> Julio Biason |
| **10:20** <td colspan=4><center>[**O que mudou ao longo de 25 anos trabalhando com Software Livre?**](#O_que_mudou_ao_longo_de_25_anos_trabalhando_com_Software_Livre?) <br> Auditório TecnoURI <br> <span class="label label-success">Principiante</span> <br> Carlos Santos | 
| **11:10** <td colspan=4><center> [**Tentar dominar o mundo!**](#Tentar_dominar_o_mundo!) <br> Auditório TecnoURI <br> <span class="label label-success">Principiante</span> <br> Luciano Camargo Cruz | 
...
Vou apresentar minha trajetória no Python e DevOps usando como referência trabalhos acadêmicos realizados durante o curso de Ciência da Computação (âmbito acadêmico) e ao longo da minha carreira (âmbito profissional) usando metodologias ágeis e tecnologias para o deploy automatizado (CI/CD). Além disso vou falar sobre o mercado aquecido para desenvolvimento oportunidades para desenvolvedores Python na região. 
...
Já parou para observar o céu numa noite estrelada? Teve curiosidade de saber o nome das constelações, estrelas, planetas e luas? Quis entender o movimento de corpos celestes no céu? O Stellarium é um Software Livre para Astronomia repleto de recursos, extremamente simples de usar roda tanto em Linux, BSDs, Mac e Windows e que pode ser instalado desde seu laptop até numa pequena Raspberry Pi. Nesta palestra veremos as principais funcionalidades do Stellarium, sua utilização e daremos os primeiros passos em direção ao hobby mais fantástico de todos, a Astronomia Amadora! 
